...
* Report a [vulnerability](https://github.com/braintree/browser-switch-android/security/advisories/new) directly via private vulnerability reporting on GitHub
